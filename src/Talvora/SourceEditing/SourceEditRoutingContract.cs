...
internal static class SourceEditRoutingContract
{
    ...
    public const string EscapeHatchRouting =
        "This remains unrestricted administration/escape-hatch capability and is not a normal source editor. For development-workspace source changes, use talvora_apply_patch as the PRIMARY/default editor; use talvora_apply_edits only when exact ranges are already known or generated.";
