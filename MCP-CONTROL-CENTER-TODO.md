...
- [x] #179 — Control Center exit window-placement race: shutdown öncesi placement yazımı deterministik tamamlanıyor, async file write UI context'e bağlanmıyor; targeted source regression RED -> GREEN, Tray Release build 0 warning / 0 error; commit/push/live gate pending.
