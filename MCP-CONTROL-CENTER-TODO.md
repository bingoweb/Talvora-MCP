...
- [x] #176 — `talvora_archive_list`: finite 20,000-entry + 8 MiB response ceiling, archive-order offset continuation, total/truncation metadata; response-bounds regression GREEN and Release build 0 warning / 0 error; commit/push/live gate pending.
