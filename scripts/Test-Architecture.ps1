...
Assert-ReferencesExactly 'src/Talvora.Platform.Windows/Talvora.Platform.Windows.csproj' @('../Talvora.Abstractions/Talvora.Abstractions.csproj')
...
Assert-ReferencesExactly 'src/Talvora.ElevatedBroker/Talvora.ElevatedBroker.csproj' @('../Talvora.Ipc.Contracts/Talvora.Ipc.Contracts.csproj')
